...
os.environ['PYTHONHASHSEED'] = '4,6,1'
os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID";
# The GPU id to use, usually either "0" or "1" or "0,1";
os.environ["CUDA_VISIBLE_DEVICES"] = "4,6,1";
...
def build_combined_categorical(FLAGS, NUM_FILTERS, FILTER_LENGTH1, FILTER_LENGTH2, optimizer_var, kernel_init_var):
    ...
    encode_smiles = SeqSelfAttention(attention_activation='sigmoid')(encode_smiles)
...
#                              num_heads=5, relative_encodings=True)
    encode_protein = SeqSelfAttention(attention_activation='sigmoid')(encode_protein)
    encode_protein = GlobalMaxPooling1D()(encode_protein)
